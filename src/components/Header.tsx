  ...
  return (
    <Drawer.Root direction="left">
      <header className="absolute top-0 left-0 z-[1000] w-full p-4">
        <div className="flex items-center gap-2">
          <Drawer.Trigger asChild>
            <button
              className="h-10 w-10 flex items-center justify-center rounded-xl border border-zinc-200 bg-white shadow-sm transition-transform hover:scale-105 relative"
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 mt-24 flex h-full w-80 flex-col rounded-r-2xl bg-zinc-50 z-[1001] shadow-2xl">
          <div className="flex items-center justify-between border-b border-zinc-200 p-4 bg-white rounded-tr-2xl">
            <Drawer.Title className="text-xl font-semibold text-zinc-900">
