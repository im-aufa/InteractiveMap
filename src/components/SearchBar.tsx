  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-64 rounded-xl border border-zinc-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-2 pl-10 pr-4 text-zinc-900 dark:text-white shadow-sm transition-all duration-300 placeholder:text-zinc-500 dark:placeholder:text-gray-400 focus:w-72 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-blue-500"
      />
